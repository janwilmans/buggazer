...
namespace BugGazer
{
    public abstract class Serializable<T> : ICloneable where T : new()
    {
        ...
        public static T Deserialize(string filePath, T defaultValue)
        {
            ...
            {
                Controller.WriteLine("!!!Exception trying to deserialize file '" + filePath + "': " + e);
                return defaultValue;
            }
#else
            catch
        ...
        public static T Deserialize(Stream stream, T defaultValue)
        {
            ...
            {
                Controller.WriteLine("!!!Exception trying to deserialize stream: " + e);
                return defaultValue;
            }
#else
            catch
        ...
        public static T Deserialize(TextReader reader, T defaultValue)
        {
            ...
            {
                Controller.WriteLine("!!!Exception trying to deserialize textreader: " + e);
                return defaultValue;
            }
#else
            catch
        ...
        public static T Deserialize(XmlReader reader, T defaultValue)
        {
            ...
            {
                Controller.WriteLine("!!!Exception trying to deserialize xmlreader: " + e);
                return defaultValue;
            }
#else
            catch
        ...
        {
            // todo: find out if we can prevent writing to file if nothing changed.
            // can we have a dirty flag set if any public member of the class T is written?
